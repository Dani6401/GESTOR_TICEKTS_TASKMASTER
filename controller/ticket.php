<?php
    ...
    /* Opciones del controlador Ticket*/
    switch($_GET["op"]){
        ...
        /* Actualizamos el ticket a cerrado y adicionamos una linea adicional */
        case "update":
        ...
        /* Listado de tickets segun usuario,formato json para Datatable JS */
        case "listar_x_usu":
        ...
        /* Listado de tickets,formato json para Datatable JS */
        case "listar":
        ...
        /* Formato HTML para mostrar detalle de ticket con comentarios */
        case "listardetalle":
            /* Listar todo el detalle segun tick_id */
                                ...
                                <header class="activity-line-item-header">
                                    <div class="activity-line-item-user">
                                        ...
                                        <div class="activity-line-item-user-status">
                                            <!-- Mostrar perfil del usuario segun rol -->
                                            <?php
                                                if ($row['rol_id']==1){
                                                    echo 'Usuario';
                                                }else{
                                    ...
                                    <section class="activity-line-action">
                                        ...
                                        <div class="cont">
                                            <div class="cont-in">
                                                ...
                                                <!-- Mostrar documentos adjunto en el detalle de ticket -->
                                                <?php
        ...
        /* Mostrar informacion de ticket en formato JSON para la vista */
        case "mostrar";
